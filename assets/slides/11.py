...
letters_num = '0123456789abcdefghijklmnopqrstuvwxyz'

binary_search(letters, 'c')
binary_search(letters_num, 'c')
...
def random_ints(n: int, low: int = 0, high: int = 100) -> list[int]:
